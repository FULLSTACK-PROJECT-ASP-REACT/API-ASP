...
public class GeocercaUpdateDto
{
    ...
    [Required(ErrorMessage = "El usuario editor es requerido")]
    [StringLength(10, ErrorMessage = "El usuario editor no puede exceder 10 caracteres")]
    public string Geocusedi { get; set; } = null!;

    [Required(ErrorMessage = "El equipo editor es requerido")]
    [StringLength(50, ErrorMessage = "El equipo editor no puede exceder 50 caracteres")]
